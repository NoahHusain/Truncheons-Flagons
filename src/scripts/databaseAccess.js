...
export const fetchTeams = () => {
  return fetch("truncheons-flagons-3bduf.ondigitalocean.app/teams")
...
export const fetchPlayers = () => {
  return fetch("truncheons-flagons-3bduf.ondigitalocean.app/players")
    .then((response) => response.json())
    .then((data) => {
...
export const fetchScores = () => {
  return fetch("truncheons-flagons-3bduf.ondigitalocean.app/scores")
    .then((response) => response.json())
    .then((data) => {
...
export const sendCurrentScores = (currentScore1) => {
  ...
  return fetch(
    "truncheons-flagons-3bduf.ondigitalocean.app/scores",
    fetchOptions
  )
    .then((response) => response.json())
    .then(() => {
